...
namespace AppStrings {
    ...
    struct EN {
        ...
        static constexpr const wchar_t* Dialog_UpdateTitle = L"New Version Available!";
        ...
        static constexpr const wchar_t* Dialog_Update_LoveTitle = L"QuickView is built with love";
        static constexpr const wchar_t* Dialog_Update_LoveMessage = L"I maintain QuickView in my spare time because I believe Windows deserves a faster, cleaner viewer. I don't have a marketing budget or a team. If you enjoy this update, the biggest contribution you can make is to Star us on GitHub or share it with a friend.";
        ...
        static constexpr const wchar_t* Settings_Option_Linear = L"Linear";
        static constexpr const wchar_t* Settings_Option_Nearest = L"Nearest Neighbor";
        static constexpr const wchar_t* Settings_Option_HighQualityCubic = L"HQ Cubic";
    ...
    struct CN {
        ...
        static constexpr const wchar_t* Settings_Option_Linear = L"线性 (Linear)";
        static constexpr const wchar_t* Settings_Option_Nearest = L"最近邻 (Nearest)";
        static constexpr const wchar_t* Settings_Option_HighQualityCubic = L"高质量双三次 (HQ Cubic)";
        ...
        static constexpr const wchar_t* Dialog_Update_LoveMessage = L"我利用业余时间维护 QuickView，只因我相信 Windows 值得拥有一个更快、更纯粹的看图工具。 我没有推广预算，也没有团队。如果您喜欢这次更新，在 GitHub 上点一颗星或分享给朋友，就是对我最大的支持。";
    };
    ...
    struct TW {
        ...
        static constexpr const wchar_t* Dialog_Update_LoveTitle = L"QuickView 源自熱愛";
        static constexpr const wchar_t* Dialog_Update_LoveMessage = L"我利用業餘時間維護 QuickView，只因我相信 Windows 值得擁有一個更快、更純粹的看圖工具。 我沒有推廣預算，也沒有團隊。如果您喜歡這次更新，在 GitHub 上點一顆星或分享給朋友，就是對我最大的支持。";
        static constexpr const wchar_t* Settings_Option_Black = L"黑色";
        static constexpr const wchar_t* Settings_Option_White = L"白色";
        ...
        static constexpr const wchar_t* Settings_Option_Linear = L"線性 (Linear)";
        static constexpr const wchar_t* Settings_Option_Nearest = L"最近鄰 (Nearest)";
        static constexpr const wchar_t* Settings_Option_HighQualityCubic = L"高品質雙三次 (HQ Cubic)";
    ...
    struct JA {
        ...
        static constexpr const wchar_t* Dialog_UpdateTitle = L"新しいバージョンが利用可能です！";
        static constexpr const wchar_t* Dialog_UpdateContent = L"v%s is ready.";
        static constexpr const wchar_t* Dialog_UpdateLogHeader = L"Changelog";
        ...
        static constexpr const wchar_t* Dialog_Update_LoveTitle = L"QuickViewは情熱から生まれました";
        static constexpr const wchar_t* Dialog_Update_LoveMessage = L"私は余暇を使ってQuickViewをメンテナンスしています。Windowsにはもっと高速でクリーンなビューアが必要だと信じているからです。予算もチームもありません。もしこの更新を気に入っていただけたら、GitHubでスターを付けるか、友人に共有していただけると最大の支援になります。";
    ...
    struct RU {
        ...
        static constexpr const wchar_t* Dialog_UpdateTitle = L"Доступна новая версия!";
        static constexpr const wchar_t* Dialog_UpdateContent = L"v%s is ready.";
        static constexpr const wchar_t* Dialog_UpdateLogHeader = L"Changelog";
        ...
        static constexpr const wchar_t* Dialog_Update_LoveTitle = L"QuickView создан с любовью";
        static constexpr const wchar_t* Dialog_Update_LoveMessage = L"Я поддерживаю QuickView в свободное время, потому что считаю, что Windows заслуживает более быстрого и чистого просмотрщика. Если вам нравится это обновление, лучшая поддержка — поставить звезду на GitHub.";
        ...
        static constexpr const wchar_t* Settings_Option_Linear = L"Линейный";
        static constexpr const wchar_t* Settings_Option_Nearest = L"Ближайший сосед";
        static constexpr const wchar_t* Settings_Option_HighQualityCubic = L"HQ Кубический";
    ...
    struct DE {
        ...
        static constexpr const wchar_t* Dialog_UpdateTitle = L"Neue Version verfügbar!";
        static constexpr const wchar_t* Dialog_UpdateContent = L"v%s is ready.";
        static constexpr const wchar_t* Dialog_UpdateLogHeader = L"Changelog";
        ...
        static constexpr const wchar_t* Dialog_Update_LoveTitle = L"QuickView wird mit Liebe entwickelt";
        static constexpr const wchar_t* Dialog_Update_LoveMessage = L"Ich pflege QuickView in meiner Freizeit, weil ich glaube, dass Windows einen schnelleren und saubereren Viewer verdient. Wenn Ihnen dieses Update gefällt, ist der größte Beitrag, uns auf GitHub einen Stern zu geben.";
        ...
        static constexpr const wchar_t* Settings_Option_Linear = L"Linear";
        static constexpr const wchar_t* Settings_Option_Nearest = L"Nächster Nachbar";
        static constexpr const wchar_t* Settings_Option_HighQualityCubic = L"HQ Kubisch";
        static constexpr const wchar_t* Settings_Option_Auto = L"Auto";
    ...
    struct ES {
        ...
        static constexpr const wchar_t* Dialog_UpdateTitle = L"¡Nueva versión disponible!";
        static constexpr const wchar_t* Dialog_UpdateContent = L"v%s está listo.";
        static constexpr const wchar_t* Dialog_UpdateLogHeader = L"Registro de cambios";
        ...
        static constexpr const wchar_t* Dialog_Update_LoveTitle = L"QuickView está hecho con amor";
        static constexpr const wchar_t* Dialog_Update_LoveMessage = L"Yo mantengo QuickView en mi tiempo libre porque creo que Windows merece un visor más rápido y limpio. Si disfrutas de esta actualización, la mayor contribución es darnos una estrella en GitHub.";
        ...
        static constexpr const wchar_t* Settings_Option_Cursor = L"Cursor";
        static constexpr const wchar_t* Settings_Option_Manual = L"Manual";
        static constexpr const wchar_t* Settings_Option_Linear = L"Lineal";
        static constexpr const wchar_t* Settings_Option_Nearest = L"Vecino más cercano";
        static constexpr const wchar_t* Settings_Option_HighQualityCubic = L"Cúbico de alta calidad";
