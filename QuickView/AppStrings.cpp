...
struct TW {
  ...
  static constexpr const wchar_t *Toolbar_Tooltip_CompareExit = L"結束對比";
  ...
  static constexpr const wchar_t *Settings_Option_Balanced = L"平衡";
  static constexpr const wchar_t *Settings_Option_Ultra = L"极速";
  static constexpr const wchar_t *Help_Header_Shortcuts = L"键盘快捷鍵";
  ...
  static constexpr const wchar_t *Settings_Label_GlassUIAnimations = L"互動動畫";
